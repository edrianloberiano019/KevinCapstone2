            ...
            >
                <div className="p-4">
                    <ul className='text-left'>
                        <li onClick={() => handleItemClick('dashboard')} className="py-3 upprcase transition-all hover:bg-[#2d6823] duration-200">
                            <div className='flex '>
                        ...
                        <li onClick={() => handleItemClick('sale')} className="py-3 uppercse transition-all hover:bg-[#2d6823] duration-200">
                            <div className='flex '>
                                <div className='flex justify-center content-center items-center align-middle px-2 text-white' >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        ...
                        <li onClick={() => handleItemClick('cate')} className="py-3 uppercae transition-all hover:bg-[#2d6823] duration-200">
                            <div className='flex'>
                                <div className='flex justify-center content-center items-center align-middle px-2 text-white' >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        ...
                        <div>
                            <button
                                onClick={() => productier()}
                                className="flex hover:pl-5 text-left w-full py-3 transition-all hover:bg-[#2d6823] duration-200"
                            >
                                <div className='flex '>
                                    <div className='flex justify-center content-center items-center align-middle px-2 text-white' >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            >
                                <button onClick={() => handleItemClick('productadd')}
                                    className={`text-lg  text-[#FFFBE6] block py-3 text-left w-full px-4 hover:pl-12 pl-10 transition-all duration-200 hover:bg-[#2d6823]
                                ...
                                <button onClick={() => handleItemClick('productlist')}
                                    className={`text-lg  text-[#FFFBE6] block py-3 text-left w-full px-4 pl-10  hover:pl-12 transition-all duration-200 hover:bg-[#2d6823]
                        ...
                        <div>
                            ...
                            >
                                <button onClick={() => handleItemClick('sca')}
                                    className={`text-lg  text-[#FFFBE6] block py-3 text-left w-full pl-10 px-4 hover:pl-12 transition-all duration-200 hover:bg-[#2d6823]
                        ...
                        <button onClick={() => handleItemClick('ca')} className={`flex hover:pl-5 text-left w-full  hover:bg-[#2d6823]  py-3 transition-all duration-200
