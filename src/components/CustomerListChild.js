        ...
        <div>
            <div className='flex justify-between'>
                ...
                <div className='flex pt-7'>
                    <input className='flex text-lg bg-gray-200 px-4 rounded-l-lg' placeholder='Search' type='search' />
            ...
            <div className='flex px-10 pt-2 '>
                <div className='w-full text-left text-xl bg-gray-200 border-t-2 border-l-2 border-gray-200 pl-4 py-2'>ID No.</div>
