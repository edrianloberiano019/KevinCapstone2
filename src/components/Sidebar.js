                ...
                ${selectedItem === 'dash' ? 'bg-[#2d6823]' : ''}`}>
                    <div className='flex '>
                        <div className="relative flex items-center content-center justify-center ml-1 group">
                            ...
                            <div className="text-lg flex text-[#FFFBE6]">
                                <div>Home</div>

                                <div className="absolute -bottom-3 left-72  w-44 backdrop-blur-md bg-opacity-80 p-2 text-sm text-white bg-[#2d6823] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    This page is for the system's analytics.
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='flex '>
                        <div className="relative flex items-center content-center justify-center ml-1 group">
                            ...
                            <div className="text-lg flex text-[#FFFBE6]">
                                ...
                                <div className="absolute -bottom-3 left-72 w-44 backdrop-blur-md bg-opacity-80 p-2 text-sm text-white bg-[#2d6823] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    This page is for the product's sales.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='flex '>
                            <div className="relative flex items-center content-center justify-center ml-1 group">
                                ...
                                <div className="text-lg flex text-[#FFFBE6]">
                                    ...
                                    <div className="absolute -bottom-3 left-72 w-44 backdrop-blur-md bg-opacity-80 p-2 text-sm text-white bg-[#2d6823] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        This page is for changes or adding the products.
                                    </div>
                                </div>
                            </div>
                        </div>
